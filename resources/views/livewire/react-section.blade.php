<div>
    <div class="mb-2" >
            <div class="flex items-center">
                {{-- @if ($userisreact) --}}
                     <span class="mr-3 inline-flex items-center cursor-pointer" wire:click="react">
                    <svg class="fill-heart text-gray-700  inline-block h-7 w-7" xmlns="http://www.w3.org/2000/svg" fill="black" viewBox="0 0 24 24" stroke="currentColor">
